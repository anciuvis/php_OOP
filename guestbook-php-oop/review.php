					...
					<form method="POST" action="" class="needs-validation mt-4" novalidate="">
						<div class="row">
							...
							<div class="col-md-6 mb-3">
								...
								<input type="text" class="form-control" id="lastName" name="l_name" placeholder="" value="" required="">
								<div class="invalid-feedback">
